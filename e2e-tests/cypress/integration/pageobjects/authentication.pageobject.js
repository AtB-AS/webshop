export const auth = {
  ...
  createProfile: () => cy.get("button").contains("Opprett profil").click({ force: true }),
  ...
  resetPassword: () => cy.get("button").contains("Tilbakestill passord").click({ force: true })
};
...
export const firebase = {
  ...
  savePassword: () => cy.get("button").contains("Save").click({ force: true }),
